...
"""
═══════════════════════════════════════════════════════════════════════════════
    IDS-SIMULA - Lanzador de Aplicación
    MF0488 - Gestión de incidentes de seguridad informática
═══════════════════════════════════════════════════════════════════════════════

Este script configura automáticamente el entorno y lanza la aplicación IDS-SIMULA.

Funciones:
- Comprueba si existe el entorno virtual (.venv)
- Crea el entorno virtual si no existe
- Instala las dependencias necesarias
- Ejecuta la aplicación principal (ids.py)
...
def print_banner():
    ...
    print("""
╔═══════════════════════════════════════════════════════════════════════════════╗
║                     IDS-IMULA - Lanzador de Aplicación                       ║
║                     MF0488 - Seguridad Informática                            ║
╚═══════════════════════════════════════════════════════════════════════════════╝
""")
